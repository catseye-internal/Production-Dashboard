...
const SERVICE_ORDERS_COLUMNS = [
  ...
  { key: 'Locked',            label: 'Confirmed?',   type: 'confirmation',     sortable: true, default: true,  width: 90 },
  ...
  { key: '_Class',            label: 'Class',        type: 'text',             sortable: true, default: true,  width: 85 },
  { key: 'Description',       label: 'Description',  type: 'text-truncate',    sortable: false, default: true, width: 180 },
  { key: 'Duration',          label: 'Min',          type: 'number',           sortable: true, default: true,  width: 45 },
  { key: 'Route',             label: 'Route',        type: 'text',             sortable: true, default: true,  width: 70 },
  { key: '_status',           label: 'Status',       type: 'status-flags',     sortable: false, default: true, width: 60 },
  { key: 'SubTotal',          label: 'Subtotal',     type: 'money',            sortable: true, default: true,  width: 75 },
  { key: '_LocAddress',       label: 'Address',      type: 'text-truncate',    sortable: true, default: true,  width: 140 },
  { key: '_LocZip5',          label: 'Zip',          type: 'text',             sortable: true, default: true,  width: 55 },
  { key: '_LocCounty',        label: 'County',       type: 'text',             sortable: true, default: true,  width: 90 },
